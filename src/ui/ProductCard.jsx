...
const ProductCard = ({ item, setSearchText }) => {
  ...
  return (
    <div className='border border-gray-200 rounded-lg p-1 overflow-hidden hover:border-[#6f1628] duration-200 cursor-pointer'>
    ...
    <Transition 
     ...
     className='relative z-10 focus:outline-none' onClose={close}>
        <div className='fixed inset-0 z-10 w-screen overflow-y-auto'>
          ...
          >
            <DialogPanel className='w-full max-w-md rounded-xl bg-black backdrop-blur-2xl
             z-50 p-6'>
              <DialogTitle
               as='h3'
