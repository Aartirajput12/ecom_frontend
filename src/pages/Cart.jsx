      ...
      {cartProduct.length > 0 ? (
        ...
        <div className='bg-white h-96 flex flex-col gap-2 items-center justify-center py-5 rounded-lg border border-gray-200 drop-shadow-2xl'>
          ...
          <p className='text-lg max-w-[600px] text-center text-gray-600 tracking-wide leading-6'>
            Your cart is empty. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eaque non amet ducimus molestias quos nostrum temporibus, magni vero nemo nulla tenetur cupiditate facilis error velit eius, voluptatum laborum dicta odio?</p>
          <Link to={"/product"} className='bg-gray-800 text-gray-200 px-8 py-4 rounded-md hover:bg-black hover:text-white duration-200 uppercase text-sm font-semibold tracking-wide'>go to shopping</Link>
        </div>
      )}
    </Container>
  )
